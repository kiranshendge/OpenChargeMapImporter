...
const address =
  mongoose.models.addressInfo || mongoose.model<AddressDoc>('Address', AddressInfoSchema);

const connection =
  mongoose.models.connections || mongoose.model<ConnectionDoc>('Connection', ConnectionSchema);
